      ...
      {isLoggedIn && (
        <div className="profile-header">
          <button
            ...
            className=" bg-tussock-500 flex items-center text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-tussock-100 hover:bg-tussock-500 dark:hover:text-tussock-400 md:me-0 focus:ring-4 focus:ring-tussock-500 dark:focus:ring-tussock-600 dark:text-white pr-5"
            type="button"
          >
